...
export declare function withStorageValidator<Value>(validator: (value: unknown) => value is Value): (storage: AsyncStorage<unknown>) => AsyncStorage<Value>;
export declare function withStorageValidator<Value>(validator: (value: unknown) => value is Value): (storage: SyncStorage<unknown>) => SyncStorage<Value>;
